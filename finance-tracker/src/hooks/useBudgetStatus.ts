...
import type { Category, VariableExpense, BudgetStatus } from '../types'
...
export function useBudgetStatus({ categories, variableExpenses }: UseBudgetStatusParams): BudgetStatus[] {
  return useMemo(() =>
    categories
